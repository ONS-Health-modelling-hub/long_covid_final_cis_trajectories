...
write.csv(lr_out, file="filepath/lr_symptoms_denom_all.csv", row.names=FALSE)
write.csv(emmeans_out, file="filepath/emmeans_symptoms_denom_all.csv", row.names=FALSE)
write.csv(pairs_out, file="filepath/pairs_symptoms_denom_all.csv", row.names=FALSE)
...
ggsave(filename="filepath/emmeans_symptoms_denom_all.jpg", width=15, height=15, units="cm", dpi=300)
